...
class configClass extends DaftarObj2 {
  ...
  return "<table cellpadding='0' cellspacing='0' border='0' id='toolbar'>
    ...
    function customColumn($title='',$custom='',$col_field='12',$col_label='6',$col_input='6')
    {
        return "
        <div class='col-md-".$col_field."'>
          <div class='form-group row'>
            <label class='col-sm-".$col_label." col-form-label'>".$title."</label>
    ...
    function textBoxColumn($title='',$id='',$value='',$col_field='12',$col_label='6',$col_input='6',$paramsExtra = "")
    {
        return "
        <div class='col-md-".$col_field."'>
          <div class='form-group row'>
            <label class='col-sm-".$col_label." col-form-label'>".$title."</label>
            <div class='col-sm-".$col_input."'>
              <input type='text' class='form-control'  name='".$id."' id ='".$id."' value='".$value."' $paramsExtra>
            </div>
          </div>
        </div>";
    }
    function textAreaBoxColumn($title='',$id='',$value='',$col_field='12',$col_label='6',$col_input='6',$params = "")
    {
        ...
        <div class='col-md-".$col_field."'>
          <div class='form-group row'>
            <label class='col-sm-".$col_label." col-form-label'>".$title."</label>
            <div class='col-sm-".$col_input."'>
              <textarea class='form-control'  name='".$id."' id ='".$id."' $params>$value</textarea>
            </div>
          </div>
        </div>";
    }
    function newRow($field = array()){
      $data = '';
...
function fujinFabMenu($id='',$href='',$title='',$img='',$style='',$Prefix)
{
  $fujinFabMenu = "
    <li>
      <a href='javascript:".$Prefix.".".$href."'
         class='zoom-fab zoom-btn-sm zoom-btn-person scale-transition scale-out '
         data-toggle='tooltip' data-placement='left' title='".$title."'
      >
        <img src='images/administrator/images/".$img."' width='22' height='22' border='0' align='middle' style='margin: 20%;'>
      </a>
    </li>";
...
function fujinCustField($title='',$custom='',$col_field='12',$col_label='6',$col_input='6')
{
    return "
    <div class='col-md-".$col_field."'>
      <div class='form-group row'>
...
function fujinFieldCol($title='',$id='',$value='',$col_field='12',$col_label='6',$col_input='6')
{
    return "
    <div class='col-md-".$col_field."'>
      <div class='form-group row'>
...
function fujinNewField($field = array()){
  $data = '';
  for ($i=0; $i < sizeof($field); $i++) {
    $data .= $field[$i];
  }
