...
"<nav class='navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row navbar-success'>
      <div class='text-center navbar-brand-wrapper d-flex align-items-center justify-content-center'>
        <a class='navbar-brand brand-logo' href='index.html'><img src='assets/rm-rf-ui/images/logo.svg' alt='logo'/></a>
        <a class='navbar-brand brand-logo-mini' href='index.html'><img src='assets/rm-rf-ui/images/logo-mini.svg' alt='logo'/></a>
      </div>
	...
	function pageShow(){
		...
		"<nav class='sidebar sidebar-offcanvas' id='sidebar'>
	        <ul class='nav'>
	            ...
	            <li class='nav-item'>
	                <a class='nav-link' href='pages.php?Pg=landingPage'>
	                    <i class='icon-server menu-icon'></i>
