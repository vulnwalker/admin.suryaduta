	 ...
	 )
{
	...
	$Str = " <input $disSebelum type=button class='btn btn-success btn-xs' value='Awal' onClick=\"$fnGotoHal('awal',$Awal)\">
			<input $disSebelum type=button class='btn btn-success btn-xs' value='Sebelum' onClick=\"$fnGotoHal('sebelum',$Sebelum)\">
			$Ops <input $disSesudah type=button class='btn btn-success btn-xs' value='Sesudah' onClick=\"$fnGotoHal('sesudah',$Sesudah)\">
			<input $disSesudah type=button class='btn btn-success btn-xs' value='Akhir' onClick=\"$fnGotoHal('akhir',$Akhir)\">
			&nbsp;<input  type=button class='btn btn-success btn-xs' value='Lihat Halaman'
			onClick=\"$fnGotoHal('goto',document.getElementById('".$NameHal."_fmHAL').value )\">&nbsp;:&nbsp;
			<input $disGoTo type='text'  size='6' maxlength='10'
				name='".$NameHal."_fmHAL' id='".$NameHal."_fmHAL' value='$Hal'  onkeypress='return isNumberKey(event,1)' style='text-align: center;
    width: 51px;'> &nbsp;
				<span style='color: red; font-size: 12px;' >$JmlHal hal &nbsp;/&nbsp; $Jumlah data</span>
			<input type=hidden id='$NameHal' name='$NameHal' value='$Hal'>
			<script language='javascript'> </script> ";
	return $Str;
}
