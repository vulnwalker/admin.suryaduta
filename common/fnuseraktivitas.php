	...
	function genDaftarOpsi($mode=1){
		...
		$TampilOpt = 			
				"<table width='100%' cellspacing='0' cellpadding='0' border='0'><tr valign='top'><td width='50%'>
					...
					<tr height=18><td><b>Asisten/OPD</td><td>:</td><td >$fmUNIT</td></tr>
					<tr height=18><td><b>Biro/UPTD/B</td><td>:</td><td >$fmSUBUNIT</td></tr>
					</table>
				</td></tr>
				</table>
			</div>".
	...
	function simpan(){
		...
		//get data -----------------
				...
				if($fmST == 0){
					...
					if($err==''){
						$aqry = "insert into ref_pegawai (a,b,c,d,e,nip,nama,jabatan)"."values('$a','$b','$c','$d','$e','$nip','$nama','$jabatan')";	$cek .= $aqry;	
						$qry = sqlQuery($aqry);
					}
		...
		$cont = 
			"<div id='div_user_info'>
				...
				<table width='100%' cellspacing='0' cellpadding='0' border='0'><tr valig='top'><td width='50%'>
					...
					<tr><td>Asisten/OPD</td><td>:</td><td>$fmUNIT</td></tr>
					<tr><td>Biro/UPTD/B</td><td>:</td><td>$fmSUBUNIT</td></tr>
					</table>
				</td></tr>
				</table>
			</div>".
