...
class UserProfilObj  extends DaftarObj2{	
	...
	function genDaftarInitial(){
		...
		if ($group!='00.00.00'){
			...
			$get = sqlArray(sqlQuery( "select * from ref_bagian where kode ='".$c.".00.00' " ));		
			if($get['nm_bagian']<>'') $fmSKPD = $get['nm_bagian'];
			$get = sqlArray(sqlQuery( "select * from ref_bagian where kode ='$c.$d.00' " ));		
			if($get['nm_bagian']<>'') $fmUNIT = $get['nm_bagian'];
			$get = sqlArray(sqlQuery( "select * from ref_bagian where kode ='$c.$d.$e' "	));		
			if($get['nm_bagian']<>'') $fmSUBUNIT = $get['nm_bagian'];			
			...
			"<div id='div_pass_edit' style='display:none;background-color: #F2F2F2;padding: 8 5 10 8; height:130'>
				<span style='width:100;float:left;'><strong>Kata Sandi</strong></span>
				  <div style='text-align:center;height:120'>
					<table cellpadding='0' cellspacing='0' border='0'>
					<tr style='height:30'><td style='width:150;text-align:right;padding:0 4 0 0;color:gray'><b>Lama: </b></td>
					...
					<tr style='height:30'><td style='width:150;text-align:right;padding:0 4 0 0;color:gray'><b>Baru: </b></td>
						<td><input type='password' id='passBaru' style='width:200' name='passBaru' value='' onKeyup=\"UserProfil.cekStatusEdit('',this,2);\"></td></tr>
		         <tr style='height:30'><td style='width:150;text-align:right;padding:0 4 0 0;color:gray'><b>Ketik Ulang Baru: </b></td>
						<td><input type='password' id='passBaru1' style='width:200' name='passBaru1' value=''></td></tr>
						<tr style='height:30'><td colspan=2  style='text-align:center'>
		...
		//view_img.php?fname=thumb_407296_708049009-645648845.jpg&photoprofil=1
			...
			<td width='500'>".
				...
				*/
				...
				<div style='padding:8 5 10 8;border-bottom:solid 1px #e9e9e9;height:18'>
				<span style='width:100;float:left;'><strong>Satuan Kerja</strong></span>
				<span style='width:200;float:left;color:gray'><b>$fmSKPD</b></span>
				<span style='width:60;float:right;text-align:right'></span>
				</div>
				<div style='padding:8 5 10 8;border-bottom:solid 1px #e9e9e9;height:18'>
				<span style='width:100;float:left;'><strong>Bagian</strong></span>
				<span style='width:200;float:left;color:gray'>$fmUNIT</span>
				<span style='width:60;float:right;text-align:right'></span>
				</div>
				<div style='padding:8 5 10 8;border-bottom:solid 1px #e9e9e9;height:18'>
				<span style='width:100;float:left;'><strong>Sub Bagian</strong></span>
