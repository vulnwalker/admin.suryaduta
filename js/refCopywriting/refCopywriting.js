var refCopywriting = new DaftarObj2({
  prefix: "refCopywriting",
  url: "pages.php?Pg=refCopywriting",
  formName: "refCopywritingForm",
  refCopywriting_form: "0", //default js refCopywriting
  loading: function() {
    //alert('loading');
    this.topBarRender();
    this.filterRender();
