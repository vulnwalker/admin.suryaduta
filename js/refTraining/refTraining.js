var refTraining = new DaftarObj2({
  prefix: "refTraining",
  url: "pages.php?Pg=refTraining",
  formName: "refTrainingForm",
  refTraining_form: "0", //default js refTraining
  loading: function() {
    //alert('loading');
    this.topBarRender();
    this.filterRender();
  ...
  saveNew: function() {
    ...
    $.ajax({
      type: "POST",
      data: $("#" + this.prefix + "_form").serialize()+"&deskripsiTraining="+$("#deskripsiTraining").html(),
  ...
  saveEdit: function(idEdit) {
    ...
    $.ajax({
      type: "POST",
      data: $("#" + this.prefix + "_form").serialize()+"&idEdit="+idEdit+"&deskripsiTraining="+$("#deskripsiTraining").html(),
