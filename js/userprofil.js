...
var UserProfil = new DaftarObj2({
	...
	batalEdit:function(i)
	{
		...
		if(document.getElementById(ide1) ) document.getElementById(ide1).style.display='block';
		if(document.getElementById(ide2) ) document.getElementById(ide2).style.display='none';	
		//document.getElementById(bt).setAttribute('class','buttonui');	
		if(document.getElementById(bt) ) document.getElementById(bt).setAttribute('disabled','true');	
		this.statusEdit=0;
