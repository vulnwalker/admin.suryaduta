...
function JmlOnLine() { 
	$n = 0; 
	$n = sqlRowCount(sqlQuery("select * from admin where online='1'")); 
	return $n; 
} 
...
NIP. 	 
"; return $Hsl; } function inputFormatRibuan($obj="obj") { global $$obj; $$obj = round($$obj,0); $str = "       "; return $str; } function ComboBarang() { global $fmBIDANG,$fmKELOMPOK,$fmSUBKELOMPOK,$fmSUBSUBKELOMPOK; $str = ""; $Kondisi = "f = '$fmBIDANG' and g = '$fmKELOMPOK' and h ='$fmSUBKELOMPOK' and i ='$fmSUBSUBKELOMPOK' and j != '00'"; $NmHEAD = "NAMA BARANG"; if(!empty($fmBIDANG) and !empty($fmKELOMPOK) and !empty($fmSUBKELOMPOK) and empty($fmSUBSUBKELOMPOK)) { $Kondisi = "f = '$fmBIDANG' and g = '$fmKELOMPOK' and h ='$fmSUBKELOMPOK' and i !='00' and j = '00'"; $NmHEAD = "NAMA SUB SUB KELOMPOK"; } if(!empty($fmBIDANG) and !empty($fmKELOMPOK) and empty($fmSUBKELOMPOK) and empty($fmSUBSUBKELOMPOK)) { $NmHEAD = "NAMA SUB KELOMPOK"; $Kondisi = "f = '$fmBIDANG' and g = '$fmKELOMPOK' and h !='00' and i ='00' and j = '00'"; } if(!empty($fmBIDANG) and empty($fmKELOMPOK) and empty($fmSUBKELOMPOK) and empty($fmSUBSUBKELOMPOK)) { $Kondisi = "f = '$fmBIDANG' and g != '00' and h ='00' and i ='00' and j = '00'"; $NmHEAD = "NAMA KELOMPOK"; } if(empty($fmBIDANG) and empty($fmKELOMPOK) and empty($fmSUBKELOMPOK) and empty($fmSUBSUBKELOMPOK)) { $Kondisi = "f != '00' and g = '00' and h ='00' and i ='00' and j = '00'"; $NmHEAD = "NAMA BIDANG"; } $ListBidang = cmbQuery1("fmBIDANG",$fmBIDANG,"select f,nm_barang from ref_barang where f!='00' and g ='00' and h = '00' and i='00' and j='00'","onChange=\"adminForm.submit()\"",'Pilih',''); $ListKelompok = cmbQuery1("fmKELOMPOK",$fmKELOMPOK,"select g,nm_barang from ref_barang where f='$fmBIDANG' and g !='00' and h = '00' and i='00' and j='00'","onChange=\"adminForm.submit()\"",'Pilih',''); $ListSubKelompok = cmbQuery1("fmSUBKELOMPOK",$fmSUBKELOMPOK,"select h,nm_barang from ref_barang where f='$fmBIDANG' and g ='$fmKELOMPOK' and h != '00' and i='00' and j='00'","onChange=\"adminForm.submit()\"",'Pilih',''); $ListSubSubKelompok = cmbQuery1("fmSUBSUBKELOMPOK",$fmSUBSUBKELOMPOK,"select i,nm_barang from ref_barang where f='$fmBIDANG' and g ='$fmKELOMPOK' and h = '$fmSUBKELOMPOK' and i!='00' and j='00'","onChange=\"adminForm.submit()\"",'Pilih',''); $str ="
GOLONGAN	:	$ListBidang
BIDANG	:	$ListKelompok
