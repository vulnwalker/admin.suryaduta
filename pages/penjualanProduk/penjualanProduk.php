...
class penjualanProdukObj extends configClass
{
    ...
    function setPage_OtherScript()
    {
        ...
        return "
        <script type='text/javascript' src='js/penjualanProduk/penjualanProduk.js' language='JavaScript' ></script>
    ...
    function genDaftarOpsi()
    {
        ...
        "<div class='row'>
            ...
            <div class='col-md-8'>
              <div class='form-group row'>
                <div class='col-sm-9'>
                  <input class='btn btn-success btn-xs' type='button' value='Tampilkan' onclick= $this->Prefix.refreshList(true);>
                </div>
              </div>
            </div>
          </div> ";
